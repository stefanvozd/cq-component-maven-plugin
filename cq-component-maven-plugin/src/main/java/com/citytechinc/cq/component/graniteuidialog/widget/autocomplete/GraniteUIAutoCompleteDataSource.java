...
public class GraniteUIAutoCompleteDataSource extends AbstractGraniteUIResourceTypedElement implements GraniteUIElement {

    public static final String FIELD_NAME = "datasource";

    public GraniteUIAutoCompleteDataSource(GraniteUIResourceTypedElementParameters parameters) {
        super(parameters);
    }
