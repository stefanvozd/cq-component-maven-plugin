...
public class GraniteUIAutoCompleteWidget extends AbstractGraniteUIWidget {

    public static final String RESOURCE_TYPE = "granite/ui/components/foundation/form/autocomplete";

    public GraniteUIAutoCompleteWidget(GraniteUIAutoCompleteWidgetParameters parameters) {
        super(parameters);
    }
