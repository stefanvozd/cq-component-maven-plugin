...
public class GraniteUIAutoCompleteOptions extends AbstractGraniteUIResourceTypedElement implements GraniteUIElement {

    public static final String FIELD_NAME = "options";

    public GraniteUIAutoCompleteOptions(GraniteUIResourceTypedElementParameters parameters) {
        super(parameters);
    }
